...
|---|------|-------------|--------|
| 1.1 | [Project Scaffolding](task-1.1-project-scaffolding.md) | Vite + React + TS + Tailwind v4 + pnpm + Biome + Vitest | Pending |
| 1.2 | [PWA Configuration](task-1.2-pwa-configuration.md) | vite-plugin-pwa, manifest, icons, offline precache, base path | Pending |
